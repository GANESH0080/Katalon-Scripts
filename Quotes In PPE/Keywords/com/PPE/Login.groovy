	...
	def correctlogin() {
		...
		for (def configDataRowCounter : (0..genericDATA.getRowNumbers() - 1))
		{
			...
			if (state == 'GA')
			{
				...
				WebUI.setText(findTestObject('Quote OR/txtfield_USERNAME'),genericDATA.internallyGetValue("GA_USERNAME", configDataRowCounter))

				// STEP 10: Entering PASSWORD from Data file in Password textfield
				WebUI.setText(findTestObject('Quote OR/txtfield_PASSWORD'),genericDATA.internallyGetValue("PASSWORD", configDataRowCounter))
			...
			else if (state == 'VA')
			{
				...
				WebUI.setText(findTestObject('Quote OR/txtfield_USERNAME'),genericDATA.internallyGetValue("VA_USERNAME", configDataRowCounter))
			...
			{
				// STEP 12: Entering USERNAME from Data file in Username textfield
				WebUI.setText(findTestObject('Quote OR/txtfield_USERNAME'),genericDATA.internallyGetValue("NC_USERNAME", configDataRowCounter))
