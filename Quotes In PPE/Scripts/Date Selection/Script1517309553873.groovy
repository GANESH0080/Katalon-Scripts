...
WebUI.click(findTestObject('Endorsement OR/btn_YES_CONFIRMATION_ENDORSEMENT'))

// Waiting
WebUI.delay(6)

// STEP 8: Entering Policy number in policy number field
WebUI.setText(findTestObject('Endorsement OR/txtfield_POLICYNUMBER_FOR_ENDORSEMENT'), 'BCIHGA1800132')

// Waiting
WebUI.delay(6)

// STEP 9: Clicking on SEARCH button
WebUI.click(findTestObject('Endorsement OR/btn_SEARCH_FOR_ENDORSEMENT'))
