...
public class IncorrectLogin 
{
	...
	WebUI.setText(findTestObject('Quote_OR/txtfield_USERNAME'), '125634')
	...
	WebUI.setText(findTestObject('Quote_OR/txtfield_PASSWORD'),'123456')
	...
	WebUI.setText(findTestObject('Quote_OR/txtfield_USERNAME'),'Ganesh')
	
	// STEP 4.2 : Entering PASSWORD in Password textfield
	WebUI.setText(findTestObject('Quote_OR/txtfield_PASSWORD'),'Salunkhe')
	...
	WebUI.setText(findTestObject('Quote_OR/txtfield_PASSWORD'),'ih.chelms')
